...
COMMENTS_FILE = "../data/tweets.json"
TRAIN_MAP_FILE = "../data/train_my_tweet.csv"
TEST_MAP_FILE = "../data/test_my_tweet.csv"
...
def build_data_cv(data_folder, cv=10, clean_string=True):
    ...
    for line in train_data: 
        ...
        if( label_str == 0):
            ...
            label = [0, 1]
        rev.append(comments[str(line[0])]['text'].strip())
        if clean_string:
        ...
        datum  = {"y":int(1), 
                  "id":str(line[0]),
                  "text": orig_rev,
                  "author": comments[str(line[0])]['author'],
                  "label": label,
...
if __name__=="__main__":  
    ...
    pickle.dump([revs, W, W2, word_idx_map, vocab, max_l], open("mainbalancedpickle_twitter.p", "wb"))
